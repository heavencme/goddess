...
//weibo_functions
//echo'<strong>'.$_SESSION['token']['access_token'].'</strong>';//test token
...
<div id="left-wrapper">
    <div id="left-content">
        <div id="left-login">
            <div class="buttons" id="login" ><a><span id="light1">y</span><span id="light2">y</span></a></div>
...
<div class="header">
        <ul id="navigation">
                <li><a href="index.php">H<p>首页</p></a></li> 
                <li><a href="new.php">t<p>朋友墙</p></a></li>
                <li><a href="huying">b<p>呼应</p></a></li>
                <li><a href="aboutus.php">i<p>我们</p></a></li>
                <li><a href="http://zisheng.org">w<p>vpn</p></a></li>
        </ul>
</div>