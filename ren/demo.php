...
// 获得指定用户
$user = $user_service->info();//s.b gives a method of $user_service->get();not defined!! 
print_r($user);
?>
...
<body>
    <p>session:<?php echo $_SESSION;?></p>
    <p>姓名：<?php echo $user['name'];?></p>
        
	<!-- 用户头像 -->
	<img src="<?php echo $user['avatar'][0]['url'];?>" title="头像" alt="头像"
		border="0" />
	<br />
	<!-- 用户名 -->
<?php echo $user['name'];?>
