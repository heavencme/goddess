...
新鲜事标题及图片的链接：<input type="text" value="http://zisheng.org" id="url" /><br/>
默认评论：<input type="text" value="Never mind, it's a test." id="message" /><br/>
action_name :<input type="text" id="action_name" value="zisheng.org" /><br>
action_link :<input type="text" id="action_link" value="http://zisheng.org/" /><br>
